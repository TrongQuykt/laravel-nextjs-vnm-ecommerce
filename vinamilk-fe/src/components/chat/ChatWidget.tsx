...
export default function ChatWidget() {
    ...
    // Đã gỡ bỏ logic can thiệp document.body.style.overflow để tránh 100% hiện tượng Layout Shift / Giật trang
    ...
    return (
        <>
            ...
            {/* Khung Chat nổi */}
            <div className={`fixed top-4 bottom-4 right-4 w-full max-w-[400px] bg-[#f0f4f9] z-[10000] rounded-xl overflow-hidden transform transition-transform duration-500 ease-in-out flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-[110%]'}`}>

                {/* Header */}
                <div className="bg-[#fffff1] p-4 flex items-center justify-between border-b border-blue-100">
                    <div className="pl-2">
                ...
                <div
                    ref={scrollRef}
                    className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#fffff1] navy-scrollbar"
                >
                ...
                <div className="relative pt-10">
                    {/* SVG Wavy Background */}
                    <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] bg-[#fffff1]">
