...
export default function ProductDetailView({
  ...
  const [selectedVariant, setSelectedVariant] = useState<ProductVariant>(
    product.variants?.[0] || { id: 0, price: 0, base_price: 0, discount_percentage: 0, sku: '', name: '', stock_quantity: 0, is_active: false, flavor: null, flavor_slug: null, volume: null, volume_slug: null, packaging_type: null, packaging_type_slug: null }
  );
            ...
            >
              ...
              <div className="pt-4 space-y-6">
                {product.usage_instructions && (
                  <div>
                    <h3 className="text-[10px] font-black uppercase tracking-widest text-[#0213b0] mb-2 py-1 border-b border-v-navy/10">Cách dùng</h3>
                ...
                {product.storage_instructions && (
                  <div>
                    <h3 className="text-[10px] font-black uppercase tracking-widest text-[#0213b0] mb-2 py-1 border-b border-v-navy/10">Hướng dẫn bảo quản</h3>
          ...
          <div className="flex flex-col gap-10">
            <div>
              <div className="flex items-center gap-2 mb-8">
                <span className="text-[11px] font-black uppercase tracking-[0.3em] text-v-navy">
                ...
                <span className="h-px w-4 bg-v-navy/20" />
                <span className="text-[11px] font-bold uppercase tracking-widest text-v-navy/60">
                  {product.product_line?.name}
                </span>
              </div>
              <h1 className="text-5xl md:text-4xl font-sans font-semibold text-blue-700 mb-6 leading-[1.05] tracking-[-0.5px]">
                {product.name}
              </h1>
              <div
            ...
            <div className="flex flex-col gap-6">
              <div ref={mainButtonRef} className="flex gap-3 items-stretch">
                ...
                <button 
                  ...
                  disabled={isLoading}
                  className="flex-1 py-3 bg-[#0213b0] text-white rounded-lg text-sm font-semibold tracking-wide hover:bg-[#172d6e] transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <div className="flex flex-col gap-1 overflow-hidden">
                    <span className="text-[10px] font-black uppercase tracking-widest text-v-navy">
        ...
        {product.features && product.features.length > 0 && (
          <section className="mt-24">
            {product.features_title && (
              <h2 className="text-center text-4xl md:text-5xl font-serif font-normal text-v-navy mb-8">{product.features_title}</h2>
            )}
