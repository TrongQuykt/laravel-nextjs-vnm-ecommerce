        ...
        {variantsInVolume.map((variant, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Right: discount + strikethrough + price + stock status */}
              <div className="flex items-center gap-2 text-right">
                {variant.available_quantity <= 0 && (
                  <span className="text-[10px] font-bold text-red-500 px-2 py-0.5 bg-red-50 rounded">
                    Hết hàng
                  </span>
                )}
                {variant.available_quantity > 0 && variant.available_quantity <= 10 && (
                  <span className="text-[10px] font-bold text-orange-500 px-2 py-0.5 bg-orange-50 rounded">
                    Còn {variant.available_quantity}
                  </span>
                )}
