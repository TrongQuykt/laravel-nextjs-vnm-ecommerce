    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row flex-1 overflow-hidden min-h-0">
          {/* Preview card - left */}
          <div className="md:w-[45%] flex-shrink-0 p-6 flex items-start justify-center bg-[#fffff1] border-r border-[#001c9a]/10 overflow-y-auto">
            <div
              style={{
                width: "100%",
                maxWidth: 280,
                background: "linear-gradient(to right, #0213b0 0px, #0213b0 10px, #e9f0f8 10px)",
                borderRadius: 10,
                padding: 16,
                boxShadow: "0 1px 6px rgba(0,28,154,0.1)",
            ...
            >
              ...
              >
                ...
                <svg
                  ...
                  style={{ color: "#001c9a", marginTop: 16 }}
                >
