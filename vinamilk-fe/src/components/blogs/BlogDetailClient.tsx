        ...
        <div className="flex flex-col lg:flex-row gap-16 relative">
          ...
          <aside className="lg:w-1/4">
            <div className="sticky top-32">
              <div className="bg-[#E9EDF5] rounded-t-xl overflow-hidden shadow-sm zigzag-bottom pb-4">
                ...
                {/* TOC List */}
                <div className="max-h-[50vh] overflow-y-auto navy-scrollbar px-2 py-4">
          ...
          <article className="lg:w-3/4">
            <div className="mb-10">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-[#002094] leading-[1.1] mb-6 tracking-tight">
                {post.title}
              </h1>
            ...
            <div className="prose prose-lg max-w-none prose-headings:text-[#002094] prose-headings:font-black prose-h2:text-4xl prose-h3:text-3xl prose-p:text-[#002094] prose-p:opacity-90 prose-img:rounded-2xl prose-img:mx-auto prose-figcaption:text-center prose-figcaption:text-xs prose-figcaption:text-gray-400 prose-figcaption:mt-2">
