...
export default function VouchersPage() {
  ...
  return (
    <div className="bg-[#fffff1] rounded-2xl p-6 md:p-8 border border-[#002094]/5 min-h-[550px] flex flex-col transition-all">
      {/* Title Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h2 className="text-[28px] font-black text-[#002094] leading-tight">Ví Voucher & Quà Tặng</h2>
      ...
      {loading ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-16 text-center animate-fade-in">
          ...
          <Link
            ...
            className="flex items-center gap-2 bg-[#002094] text-white font-bold text-[12px] px-6 py-3 rounded-xl tracking-wider"
          >
