  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="relative flex-1 flex">
        ...
        {/* Sidebar Overlay */}
        <div className="absolute top-[120px] right-4 md:right-10 z-[1000] w-[90vw] md:w-[380px] h-[calc(100vh-160px)] bg-[#FDFCF0] shadow-2xl rounded-md flex flex-col pointer-events-auto">
          ...
          {/* List Content */}
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#002094]/20 p-5">
            {!selectedProvince ? (
