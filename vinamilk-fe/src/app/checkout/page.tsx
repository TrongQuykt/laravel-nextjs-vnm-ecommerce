                ...
                <div className="space-y-6">
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-4">
                      ...
                      <div className="text-right flex-shrink-0">
                        <p className="text-[13px] text-gray-400 line-through">{(toVND(item.variant.base_price) * item.quantity).toLocaleString()}đ</p>
                        <p className="text-[16px] font-black text-[#002060]">{(toVND(item.variant.price) * item.quantity).toLocaleString()}đ</p>
                      </div>
                    </div>
                  ))}
                  ...
                  {rewards.map((reward, i) => (
                    <div key={i} className="flex gap-4 bg-[#e7f9a1] p-3 border border-[#e7f9a1]">
                      <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center p-2 relative border border-[#e7f9a1]">
                      ...
                      {reward.options && reward.options.length > 1 && (
