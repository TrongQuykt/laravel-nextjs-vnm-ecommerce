...
export default function RewardsPage() {
    ...
    return (
        <div className="bg-[#fcfaf2] min-h-screen font-sans text-[#002094]">
            ...
            {/* NEW HERO SECTION */}
            <section className="bg-[#002094] relative h-[750px] w-full pt-20 overflow-hidden">
                ...
                <div className="absolute flex w-full justify-center top-[180px]">
                    <div className="flex flex-col items-center gap-6 text-center">
                        <div className="flex flex-col text-center text-white">
                            ...
                            <h2 className="text-4xl font-bold uppercase">{data?.user.name}</h2>
                        </div>
                ...
                <>
                    ...
                    <div className="fixed top-4 bottom-4 right-4 w-full max-w-[420px] bg-white z-[9999] flex flex-col animate-slide-left rounded-[12px] overflow-hidden shadow-2xl">
                        ...
                        <div className="flex-1 overflow-y-auto px-8 py-10 custom-scrollbar">
                            ...
                            <div className="space-y-4 text-[#002094] text-[11px] font-medium leading-relaxed pb-10">
    ...
    return (
        <div onClick={onClick} className="bg-white border border-gray-200 overflow-hidden cursor-pointer flex flex-col group">
            <div className="w-full relative bg-white">
                {reward.image ? (
                    <img src={reward.image} className="w-full h-auto block transition-transform group-hover:scale-105 duration-500" />
                ) : (
            ...
            <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="space-y-1 mb-6 h-10 overflow-hidden">
                    {reward.description.split('\n').slice(0, 2).map((line, i) => (
                        <p key={i} className="text-[11px] text-gray-400 line-clamp-1">{line}</p>
                    ))}
                </div>
