    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm md:col-span-2 flex flex-col justify-between">
            ...
            <div class="mt-6 border-t border-gray-100 dark:border-gray-800 pt-4 text-right">
                <x-filament::button wire:click="testConnection" wire:loading.attr="disabled" class="bg-primary-600 hover:bg-primary-700 shadow-sm font-bold text-sm">
                    <span wire:loading.remove> Kiểm tra kết nối API GHN </span>
                    <span wire:loading> Đang kiểm tra... </span>
                </x-filament::button>
            </div>
        </div>
    </div>
        ...
        @if($isLoading)
            ...
            <div class="p-6 space-y-4">
                <div class="animate-pulse space-y-3">
                    @for($i = 0; $i < 5; $i++)
                        <div class="flex items-center space-x-4 border-b border-gray-100 dark:border-gray-800 pb-3">
                            ...
                            <div class="h-4 bg-gray-200 dark:bg-gray-800 rounded w-16"></div>
                            <div class="h-4 bg-gray-200 dark:bg-gray-800 rounded w-24"></div>
                            <div class="h-8 bg-gray-200 dark:bg-gray-800 rounded w-24 ml-auto"></div>
                        </div>
                    @endfor
                </div>
            </div>
        @elseif(count($ghnOrders) > 0)
                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-900/50 transition-colors">
                                ...
                                <td class="p-4 pr-6 text-right">
                                    @if($order->tracking_number)
                                        ...
                                        >
                                            <span wire:loading.remove> Đồng bộ hành trình </span>
                                            <span wire:loading> Đang đồng bộ... </span>
                                        </x-filament::button>
                                    @else
