        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex-1">
                ...
                <p class="mt-2 text-lg leading-8 text-slate-600">
                    Hôm nay là một ngày tuyệt vời để quản lý hệ thống Vinamilk Core. Bạn có <span class="font-semibold text-blue-600">5 đơn hàng mới</span> cần xử lý.
                </p>
                <div class="mt-6 flex items-center gap-x-6">
                    <a href="/admin/orders" class="rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-colors">
                        Xem đơn hàng
                    </a>
                    <a href="#" class="text-sm font-semibold leading-6 text-slate-900 border-b border-transparent hover:border-slate-900 transition-all">
                        Xem báo cáo chi tiết <span aria-hidden="true">→</span>
                    </a>
                </div>
            </div>
