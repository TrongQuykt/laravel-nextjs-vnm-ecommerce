...
class ProductResource extends Resource
{
                                    ...
                                    ->schema([
                                        Forms\Components\Section::make()
                                            ->schema([
                                                ...
                                                Forms\Components\TextInput::make('stock_quantity')->label('Số lượng kho')->numeric()->default(0),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('category')->relationship('category', 'name')->label('Danh mục'),
                Tables\Filters\SelectFilter::make('brand')->relationship('brand', 'name')->label('Thương hiệu'),
            ])
            ->actions([
