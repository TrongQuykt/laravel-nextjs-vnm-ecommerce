...
class PaymentService
{
    ...
    protected function createVnpayUrl($order)
    {
        ...
        $inputData = [
            ...
            "vnp_ReturnUrl" => $this->frontendUrl() . "/payment-result",
    ...
    protected function createStripeUrl($order)
    {
        ...
        try {
            ...
            $session = Session::create([
                ...
                'mode' => 'payment',
                'success_url' => $this->frontendUrl() . "/payment-result?order=" . $order->order_number . "&status=success",
            ...
            $orderResponse = Http::timeout(15)
                ...
                ->post("$baseUrl/v2/checkout/orders", [
                    ...
                    'application_context' => [
                        ...
                        'user_action' => 'PAY_NOW',
                        'return_url' => $this->frontendUrl() . "/payment-result?order=" . $order->order_number . "&status=success",
                        'cancel_url' => $this->frontendUrl() . "/payment-result?order=" . $order->order_number . "&status=cancel",
                    ]
                ]);
